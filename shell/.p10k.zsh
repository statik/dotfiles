# Generated by Powerlevel10k configuration wizard on 2025-05-14 at 09:12 EDT.
...
# round separators, blurred heads, blurred tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|terraform|pulumi|terragrunt|ptd'
